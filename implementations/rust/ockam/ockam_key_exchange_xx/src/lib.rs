...
pub trait XXVault:
    SecretVault + Hasher + AsymmetricVault + SymmetricVault + ockam_core::traits::AsyncClone + Clone + Send + 'static
{
}

impl<D> XXVault for D where
    D: SecretVault + Hasher + AsymmetricVault + SymmetricVault + ockam_core::traits::AsyncClone + Clone + Send + 'static
{
}
